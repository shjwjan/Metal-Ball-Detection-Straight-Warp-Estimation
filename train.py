...
Usage:
    $ python train.py --data data/metal_fourclass/data.yaml --weights yolov5s.pt --img 640
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default='data_mask.yaml', help='dataset.yaml path')
